...
export default function InteriorsHome() {
  ...
  const { data } = useApi(() => projectService.list({ limit: 9 }), []);
  const { data: settingsData, loading: settingsLoading } = useApi(() => siteSettingsService.get(), []);
  ...
  return (
    <PageTransition>
      ...
      <section className="relative flex min-h-[65vh] sm:min-h-[80vh] items-center overflow-hidden">
        <video autoPlay muted loop playsInline src="/videos/hero-interiors.mp4" className="absolute inset-0 h-full w-full object-cover" />
        ...
        <div className="container-feroze relative z-10 pt-16 sm:pt-20">
          ...
          <p className="mt-5 max-w-xl font-body text-body text-muted">{BRANDS.interiors.descriptor}</p>
        ...
        <div className="container-feroze grid gap-10 md:grid-cols-[auto,1fr] md:gap-16">
          ...
          <div className="max-w-3xl">
            ...
            <p className="mt-6 font-body text-body text-muted">
              ...
              complete interior solutions tailored to each client's vision across restaurants, cafes, hotels,
      ...
      <section className="bg-bg pb-14 md:pb-24">
        <div className="container-feroze">
          ...
          <ProjectsGrid projects={projects} loading={!data} />
      ...
      <section className="bg-surface py-14 md:py-24">
        <div className="container-feroze grid items-center gap-12 md:grid-cols-2">
          {!settingsLoading && (
            <LazyImage
              key={founderImage || 'interiors-placeholder'}
              src={founderImage || undefined}
              seed="feroz-shaikh-portrait"
              label={founderName}
              alt={founderName + ', Founder & Principal Designer'}
          ...
          <div>
            ...
            <p className="mt-6 font-body text-body text-muted">
              ...
              into a studio that has delivered over 5,00,000 sq ft across India and the Middle East.
            </p>
